...
public class Router {
    public static void main(String[] args) throws Exception {
        ...
        if (ID.equals("R1")) {
            forwardingTable.put("net1", "S1:S1realAdr:S1realPort");
            forwardingTable.put("net2", "R2:R2realAdr:R2realPort");
            forwardingTable.put("net3", "R2:R2realAdr:R2realPort");
        } else if (ID.equals("R2")) {
            forwardingTable.put("net1", "R1:R1realAdr:R1realPort");
            forwardingTable.put("net2", "R1:R1realAdr:R1realPort");
            forwardingTable.put("net3", "S2:S2realAdr:S2realPort");
        }
